...
INSERT INTO books VALUES('978-0061120084','To Kill a Mockingbird','Harper Lee','Fiction',19.989999999999998436);
...
email text, isbn INTEGER REFERENCES Books(BookID));
INSERT INTO customers VALUES(2,'Bob','Smith','bob@gmail.com','978-0061120084');
INSERT INTO customers VALUES(3,'Charlie','Williams','charlie@gmail.com','978-1451673319');
INSERT INTO customers VALUES(4,'David','Brown','david@gmail.com','978-0060558126');
INSERT INTO customers VALUES(5,'Eve','Davis','eve@gmail.com','978-0547928227');
INSERT INTO customers VALUES(6,'Frank','Jones','frank@gmail.com','978-1400031702');
INSERT INTO customers VALUES(7,'Grace','Miller','grace@gmail.com','978-0060256654');
INSERT INTO customers VALUES(8,'New','Customer','new@gmail.com',NULL);
CREATE VIEW CustomerPurchases AS
SELECT Customers.FirstName, Customers.LastName, Books.Title
FROM Customers
INNER JOIN Books ON Customers.ISBN = Books.ISBN;
COMMIT;
